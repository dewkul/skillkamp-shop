...
export default function ItemsListCheckout() {
    ...
    return (
        <div>
            ...
            <div class="grid grid-cols-4 lg:grid-cols-5 mt-10 mb-5">
                <h3 class="font-semibold text-gray-600 text-xs uppercase col-span-2"></h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercasetext-center">Quantity</h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercase text-center">Unit Price</h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercase text-center hidden lg:block">Price</h3>
            </div>
            {
                cartList.value
            ...
            <Link href="/shop"
                class="flex font-semibold text-sm text-secondary-600 mt-10"
            >
